...
namespace System.Uniques
{
    public unsafe static class HashKeyExtensions64
    {
        ...
        {
            if (obj is Byte[])
                return HashHandle64.ComputeHashBytes((Byte[])obj, seed);
            ...
            return HashHandle64.ComputeHashBytes(buffer, offset, seed);
        }
        ...
        {
            if (obj is Byte[])
                return (long)HashHandle64.ComputeHashKey((Byte[])obj, seed);
            ...
            return (long)HashHandle64.ComputeHashKey(buffer, offset, seed);
        }      
        ...
        {
            return (long)HashHandle64.ComputeHashKey(obj.GetKeyBytes(), seed);
        }
    ...
    public unsafe static class HashKeyExtensions32
    {
        ...
        {
            if (obj is Byte[])
                return HashHandle32.ComputeHashBytes((Byte[])obj, seed);
            ...
            return HashHandle32.ComputeHashBytes(buffer, offset, seed);
        }
        ...
        {
            if (obj is IUnique)
                return ((IUnique)obj).GetHashBytes32().ToInt32();
            if (obj is ValueType)
        ...
        {
            if (obj is Byte[])
                return (int)HashHandle32.ComputeHashKey((Byte[])obj, seed);
            ...
            return (int)HashHandle32.ComputeHashKey(buffer, offset, seed);
        }
        ...
        {
            return (int)HashHandle32.ComputeHashKey(obj.GetKeyBytes(), seed);
        }
