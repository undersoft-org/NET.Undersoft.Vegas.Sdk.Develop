...
/*******************************************************************************
    ...
    System.Multemic.SharedAlbum
    
    Abstract class for Safe-Thread CardBook, 
...
{
    public abstract class SharedAlbum<V> : CardBook<V>
    {
        #region Globals       
        ...
        public SharedAlbum() : base(16, HashBits.bit64)
        {
        }
        public SharedAlbum(int capacity = 17, HashBits bits = HashBits.bit64) : base(capacity, bits)
        {      
        }
        public SharedAlbum(IList<V> collection, int capacity = 17, HashBits bits = HashBits.bit64) : this(capacity > collection.Count ? capacity : collection.Count, bits)
        {
            foreach (var c in collection)
                this.Add(c);
        }
        public SharedAlbum(IList<IUnique<V>> collection, int capacity = 17, HashBits bits = HashBits.bit64) : this(capacity > collection.Count ? capacity : collection.Count, bits)
        {
            foreach (var c in collection)
                this.Add(c);
        }
        public SharedAlbum(IEnumerable<V> collection, int capacity = 17, HashBits bits = HashBits.bit64) : this(capacity, bits)
        {
            foreach (var c in collection)
                this.Add(c);
        }
        public SharedAlbum(IEnumerable<IUnique<V>> collection, int capacity = 17, HashBits bits = HashBits.bit64) : this(capacity, bits)
        {
            foreach (var c in collection)
                this.Add(c);
        }
